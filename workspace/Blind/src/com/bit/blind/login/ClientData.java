...
public interface ClientData {
	...
	String q0 = "Q0\n처음 2분간은 자유롭게 대화를 나눠주세요.\n질문은 총 5개로 구성되어 있으며 각각의 질문에 대한 답을 선택할 시간은 30초" +
			"\n서로의 답에 대해서 대화를 할 시간은 2분씩 주어집니다." +
			"\n답이 서로 매칭되었을 시 초록색 매칭이 되지 않았을 때는 불이들어오지 않습니다." +
			"\n확인을 하셨으면 아래 아무버튼이나 눌러주시면 대화가 시작됩니다.";
